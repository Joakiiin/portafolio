    <script src="../public/datatable/jquery-3.6.1.min.js"></script>

    <!-- Font awesome kit code -->
    <script src="https://kit.fontawesome.com/6fbc440edd.js" crossorigin="anonymous"></script>
    ...
    <script src="../public/datatable/dataTables.fixedHeader.min.js"></script>
    <script src="../public/datatable/dataTables.responsive.min.js"></script>
    <script src="../public/bootstrap/responsive.bootstrap.min.js"></script>

    <!-- JS Sweetalert -->
    <script src="../public/sweetalert2/sweetalert2@11.js"></script>

    <!-- Sección de botones de datatable -->
